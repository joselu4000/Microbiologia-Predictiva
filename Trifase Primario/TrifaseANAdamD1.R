...
plot(times, y_data, col = "red", lwd = 2, 
     ...
     main = "Trifase ode-Adam Datos 1")
lines(out[, "time"], out[, "y"], col = "black", lwd = 2)
lines(rep(optimized_params[2],2),c(0,optimized_params[1]),lty = 2, col = "blue")
lines(rep(optimized_params[3],2),c(0,optimized_params[4]),lty = 2, col = "blue")
